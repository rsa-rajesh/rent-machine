...
/// requirements.
class AuthCredentialV2 {
  // ignore: public_member_api_docs
  @protected
  const AuthCredentialV2({
  ...
  @override
  String toString() =>
      'AuthCredential(providerId: $providerId, signInMethod: $signInMethod, token: $token, accessToken: $accessToken, idToken: $idToken)';
}
